...
function renderMockSetup(){
  ...
  document.getElementById('mock-area').innerHTML='<div class="card">'
    ...
    +'<button class="stat" style="cursor:pointer;text-align:left;border:1px solid #ddd" onclick="navTo(\'review\');renderReviewList(\'wrong\')"><div class="k">错题</div><div class="v redtext">'+wc+'</div><div class="sub">点击查看全部</div></button>'
    +'<button class="stat" style="cursor:pointer;text-align:left;border:1px solid #ddd" onclick="navTo(\'review\');renderReviewList(\'dk\')"><div class="k">不会</div><div class="v orangetext">'+dc+'</div><div class="sub">点击查看全部</div></button>'
    +'</div>'
