...
function loadQ(i){
  ...
  document.getElementById('dkbtn').classList.toggle('on',!!QZ.dk[i]);
...
function reviewItemHTML(entry,type){
  ...
  return '<div style="border:1px solid #dddbd3;border-radius:8px;overflow:hidden;margin-bottom:8px">'
    +'<div style="display:flex;align-items:center;gap:8px;padding:10px 14px;background:#f0efe9;cursor:pointer" onclick="toggleRI(\''+q.id+'\')">'
